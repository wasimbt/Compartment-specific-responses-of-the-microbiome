...
set.seed(101)
CMRE5_Waterb_Ctrc_otu_net <- spiec.easi(CMRE5_Waterb_Ctrc_otu, method='mb', lambda.min.ratio=1e-1, nlambda=50, pulsar.params=list(rep.num=99)) 
...
##########SPIEC-EASI network reconstruction
set.seed(101)
CMRE5_Sedimentb_Ctrc_otu_net <- spiec.easi(CMRE5_Sedimentb_Ctrc_otu, method='mb', lambda.min.ratio=1e-1, nlambda=50, pulsar.params=list(rep.num=99)) 
...
##########SPIEC-EASI network reconstruction
set.seed(101)
CMRE5_Soilb_Ctrc_otu_net <- spiec.easi(CMRE5_Soilb_Ctrc_otu, method='mb', lambda.min.ratio=1e-3, nlambda=50, pulsar.params=list(rep.num=99)) 
...
##########SPIEC-EASI network reconstruction
set.seed(101)
CMRE5_Rootb_Ctrc_otu_net <- spiec.easi(CMRE5_Rootb_Ctrc_otu, method='mb', lambda.min.ratio=1e-1, nlambda=50, pulsar.params=list(rep.num=99)) 
...
##########SPIEC-EASI network reconstruction
set.seed(101)
CMRE5_Mouseb_Ctrc_otu_net <- spiec.easi(CMRE5_Mouseb_Ctrc_otu, method='mb', lambda.min.ratio=1e-1, nlambda=50, pulsar.params=list(rep.num=99)) 
